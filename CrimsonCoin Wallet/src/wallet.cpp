...
// crimsoncoin: total coins staked (non-spendable until maturity)
...
// CrimsonCoin: get current stake weight
...
// crimsoncoin: check 'spent' consistency between wallet and txindex
// crimsoncoin: fix wallet spent state according to txindex
...
// crimsoncoin: disable transaction (only for coinstake)
